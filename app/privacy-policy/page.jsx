    ...
    return (
        <>
            ...
            <section className="hero">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-0 mx-auto max-w-screen-xl px-4 pt-[6rem] md:pt-[4rem] lg:pt-[4rem] lg:pb-10 md:px-[4.4rem] lg:h-[440px] lg:items-center lg:px-[4.3rem]">
                    <h1 className="text-3xl font-bold text-white md:text-[20px] lg:text-[44px] max-w-screen-xl lg:pr-0 py-7 lg:py-0 lg:mt-24">
                        Privacy Policy
                    </h1>
                </div>
            </section>
            ...
            <section className='mx-auto max-w-screen-xl px-4 lg:px-[4.3rem] py-16'>
                <div className='privacyPolicy'>
                    ...
                    <ul>
                        ...
                        <li>CCPA and/or CPRA refers to California Consumer Privacy Act (the “CCPA”) as amended by the California Privacy Rights Act of 2020 (the “CPRA”).</li>
                        <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Internetcablecompanies.com which is owned by LISAM SOLUTIONS LLC.</li>
                        ...
                        <li>Website refers to Internetcablecompanies.com, accessible from https://internetcablecompanies.com/ which is owned by LISAM SOLUTIONS LLC.</li>
                    ...
                    <ul>
                        <li>We do not use any email marketing software/platforms. This is not applicable to us.Their Privacy Policy can be viewed at https://internetcablecompanies.com/privacy-policy/</li>
                    </ul>
                    ...
                    <ul>
                        <li>Category A: Identifiers.Examples: A real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, driver’s license number, passport number, or other similar identifiers.Collected: Yes.</li>
                        <li>Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)).Examples: A name, signature, Social Security number, physical characteristics or description, address, telephone number, passport number, driver’s license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information. Some personal information included in this category may overlap with other categories.Collected: Yes.</li>
                        ...
                        <li>Category D: Commercial information.Examples: Records and history of products or services purchased or considered.Collected: No.</li>
                        <li>Category E: Biometric information.Examples: Genetic, physiological, behavioral, and biological characteristics, or activity patterns used to extract a template or other identifier or identifying information, such as, fingerprints, faceprints, and voiceprints, iris or retina scans, keystroke, gait, or other physical patterns, and sleep, health, or exercise data.Collected: No.</li>
                        <li>Category F: Internet or other similar network activity.Examples: Interaction with our Service or advertisement.Collected: Yes.</li>
                        <li>Category G: Geolocation data.Examples: Approximate physical location.Collected: No.</li>
                        <li>Category H: Sensory data.Examples: Audio, electronic, visual, thermal, olfactory, or similar information.Collected: No.</li>
                        <li>Category I: Professional or employment-related information.Examples: Current or past job history or performance evaluations.Collected: No.</li>
                        ...
                        <li>Category K: Inferences drawn from other personal information.Examples: Profile reflecting a person’s preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes.Collected: No.</li>
                        <li>Category L: Sensitive personal information.Examples: Account login and password information, geolocation data.Collected: Yes.</li>
                    </ul>
                    ...
                    <p>We do not sell personal information as the term sell is commonly understood. We do allow Service Providers to use Your personal information for the business purposes described in Our Privacy Policy, and these may be deemed a aale under CCPA/CPRA.</p>
                    ...
                    <ul>
                        <li>By email: info@internetcablecompanies.com</li>
                    </ul>
                    ...
                    <p>We do not sell personal information as the term sell is commonly understood. We do allow Service Providers to use Your personal information for the business purposes described in Our Privacy Policy, and these may be deemed a sale under CCPA/CPRA.</p>
                    ...
                    <ul>
                        <li>Affiliate means an entity that controls, is controlled by or is under common control with a party, where “control” means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                        <li>Country refers to: California, United States</li>
                        <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Best Cable & Satellite TV, PO Box 236, Imperial, CA 92251, which is owned by WiFi Now! LLC.</li>
                        <li>Device means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
                        <li>Service refers to the Website.</li>
                        ...
                        <li>Website refers to Best Cable & Satellite TV, accessible from https://internetcablecompanies.com/, which is owned by LISAM SOLUTIONS LLC.</li>
                        <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                    </ul>
